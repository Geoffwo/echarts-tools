...
const pie3dOut = (params, chart, config={}) => {
    ...
    // 3.1 取消悬停状态
    const hoveredSector = chartOption.series[hoveredSeriesIndex];
    const {pieData} = hoveredSector
    hoveredSector.parametricEquation = getParametricEquation({
...
// 注册策略并添加元数据
registerSimpleEventHandler('pie3dOut', pie3dOut, '3D饼图、环状图-鼠标移出样式处理');
